...
export class AdminErrorBoundary extends React.Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="p-6 sm:p-8 rounded-3xl bg-zinc-900/95 border border-rose-500/30 text-white space-y-6 max-w-4xl animate-fade-in shadow-2xl">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <button
              ...
              className="px-5 py-2.5 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs shadow-lg shadow-blue-600/20 flex items-center gap-2 transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-2xl bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-xs font-bold transition-colors cursor-pointer"
            >
              Reload Page
            </button>
          </div>
